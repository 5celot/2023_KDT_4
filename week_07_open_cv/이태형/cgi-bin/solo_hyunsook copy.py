    ...
    <body>
        <div id="back">
            ...
            <div class="main">
                ...
                <div class="moto2"><img class="img" src="/solo/user.jpg" width=500px height=500px></div>
            ...
            <div class="main">
                ...
                <div style="position: relative; width:100%; height:100%;"> 
                    <img class="hsook1" src="/solo/hyunsook/현숙(1).jpg" style="top:120px; left:10px; transform: rotate(45deg);">
                    <img class="hsook2" src="/solo/hyunsook/현숙(2).jpg">
                    <img class="hsook3" src="/solo/hyunsook/현숙(3).jpg">
                    <img class="hsook4" src="/solo/hyunsook/현숙(4).jpg">
                    <img class="hsook5" src="/solo/hyunsook/현숙(5).jpg">
                    <img class="hsook6" src="/solo/hyunsook/현숙(6).jpg">
                </div>
